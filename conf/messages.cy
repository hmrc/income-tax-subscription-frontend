...
your-income-source.foreign-property.description                 = Os ydych yn cael incwm o eiddo sydd mewn gwlad arall, mae gennych fusnes eiddo tramor. Er enghraifft, incwm o roi tai, fflatiau, neu gartrefi gwyliau ar osod – a hynny ar sail tymor hir neu dymor byr.
your-income-source.foreign-property.label                       = Ffynhonnell incwm o eiddo tramor
your-income-source.foreign-property.add-link                    = Ychwanegu busnes eiddo tramor
...
cannot-sign-up-yet.para1                                          = Ni all pobl sydd â mathau penodol o incwm neu ddidyniadau gofrestru ar gyfer Troi Treth yn Ddigidol ar gyfer Treth Incwm. (yn agor tab newydd)
...
agent.voluntary-what-you-need-to-do.para-3 = Rydych hefyd yn cytuno y bydd ein cosbau newydd yn berthnasol i’ch cleient os bydd yn methu’r dyddiadau cau ar gyfer:
agent.voluntary-what-you-need-to-do.bullet-5 = cyflwyno ei Ffurflen Dreth
agent.voluntary-what-you-need-to-do.bullet-6 = talu ei fil
