...
your-income-source.manage.label                                 = Ychwanegwch bob un o’r ffynonellau hyn yr ydych yn cael incwm ohonynt.
...
agent.business.what-year-to-sign-up.heading                     = When do you want to start using Making Tax Digital for Income Tax? (NEEDS WELSH)
...
agent.business.what-year-to-sign-up.para-two.link-text          = sut i anfon diweddariadau chwarterol
...
agent.business.what-year-to-sign-up.option-current-hint         = You or your client will need to use your software to send any missed quarterly updates for the year so far (NEEDS WELSH)
