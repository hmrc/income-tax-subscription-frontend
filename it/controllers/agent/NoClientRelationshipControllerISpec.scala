...
class NoClientRelationshipControllerISpec extends ComponentSpecBase {
  ...
  "GET /error/no-client-relationship" should {
    "show the no agent client relationship page" in {
      Given("I setup the Wiremock stubs")
      AuthStub.stubAuthSuccess()

      When("GET /error/no-client-relationship is called")
      val res = IncomeTaxSubscriptionFrontend.noClientRelationship()
