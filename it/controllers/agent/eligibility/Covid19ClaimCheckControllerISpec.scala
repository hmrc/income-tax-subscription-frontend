...
class Covid19ClaimCheckControllerISpec extends ComponentSpecBase {
  ...
  object Covid19ClaimCheckMessages {
    ...
    val join_pilot_point_1: String = "Self-Employment Support Scheme This link opens in a new tab."
    val join_pilot_point_2: String = "Coronavirus Job Retention Scheme This link opens in a new tab."
    val still_sign_up_your_client: String = "You can still sign your client up if they’ve only claimed a rebate through the:"
    val claim_sick_pay: String = "Coronavirus Statutory Sick Pay Rebate Scheme This link opens in a new tab."
    val test_and_support_pay_scheme: String = "Test and Trace Support Payment Scheme This link opens in a new tab."
    val local_authority_grants: String = "Local Authority grants This link opens in a new tab."
