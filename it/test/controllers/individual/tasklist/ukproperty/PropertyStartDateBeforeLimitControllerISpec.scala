  ...
  s"GET ${routes.PropertyStartDateBeforeLimitController.show()}" when {
    ...
    "the user does not have a journey state" should {
      "redirect the user to the home page" in {
        ...
        val result = IncomeTaxSubscriptionFrontend.ukPropertyStartDateBeforeLimit(includeState = false)
  ...
  s"POST ${routes.PropertyStartDateBeforeLimitController.submit().url}" when {
    ...
    "the user does not have a journey state" should {
      "redirect the user to the home page" in {
        ...
        val result = IncomeTaxSubscriptionFrontend.submitUKPropertyStartDateBeforeLimit(includeJourneyState = false)(request = None)
