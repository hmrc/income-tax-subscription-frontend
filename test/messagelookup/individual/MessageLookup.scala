...
object MessageLookup {
  ...
  object TaskList {
    ...
    val item3 = "Review and sign up"
    val item2Para = "Add any sole trader or UK and foreign property income sources you have."
    val agentItem1 = "Your client’s information"
    val agentItem2 = "What we need to sign up your client"
    val agentItem3 = "Review and sign up"
    ...
    val selectTaxYearHintBoth = "You can sign up your client during the current tax year or from next year"
    val selectNextTaxYearHint = "You can only sign up your client from next tax year"
    val complete = "Completed"
    val incomplete = "Incomplete"
    val notStarted = "Not started"
    val inProgress = "In progress"
    val cannotStart = "Cannot start yet"
    val addBusiness = "Add an income source"
    val addYourIncomeSources = "Your income sources"
    val addYourIncomeSourcesHint = "Include any of your sole trader or property income sources"
    val selectYourTaxYearHintBoth = "You can sign up during the current tax year or from next tax year"
    val selectYourNextTaxYearHint = "You can only sign up from next tax year"
    val ReviewAndSignUpText = "Sign up"
    val ReviewAndSignUpHint = "Complete your income details and starting tax year before you sign up"
  ...
  object TaxYearCheckYourAnswers {
    ...
    val individualQuestion = "Tax year"
