...
import connectors.httpparsers.AddressLookupResponseHttpParser.InitAddressLookupHttpReads
...
class AddressLookupResponseHttpParserSpec extends UnitTestTrait with EitherValues {
  ...
  "InitAddressLookupHttpReads" when {
    "read" should {
      ...
      "parse any other http status as a AddressLookupFailureResponse" in {
        ...
        res.left.value mustBe AddressLookupFailureResponse(BAD_REQUEST)
      }
    }
  }
}
