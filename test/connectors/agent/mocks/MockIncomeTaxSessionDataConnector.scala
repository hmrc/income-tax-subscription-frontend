...
trait MockIncomeTaxSessionDataConnector {

  val mockIncomeTaxSessionDataConnector: IncomeTaxSessionDataConnector = mock[IncomeTaxSessionDataConnector]

  def mockSetupVAndCSessionData(mtditid: String, nino: String, utr: String)(result: Boolean): Unit =
    when(mockIncomeTaxSessionDataConnector.setupViewAndChangeSessionData(
