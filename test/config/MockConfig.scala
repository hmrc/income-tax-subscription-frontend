...
trait MockConfig extends UnitTestTrait with AppConfig {
  ...
  override val incomeTaxSelfEmploymentsSoleTraderStartDateBeforeLimitUrl: String = "/report-quarterly/income-and-expenses/sign-up/self-employments/details/business-start-date-before-limit"
