...
class GlobalCheckYourAnswersViewSpec extends ViewSpec {
  ...
  object GlobalCheckYourAnswersMessages {
    ...
    object IncomeSources {
      ...
      val firstIncome: String = s"${appConfig.agentIncomeTaxSelfEmploymentsFrontendBusinessCheckYourAnswersUrl}?id=id-1&isEditMode=true"
      val nextIncome: String = s"${appConfig.agentIncomeTaxSelfEmploymentsFrontendBusinessCheckYourAnswersUrl}?id=id-2&isEditMode=true"
      ...
      object UKProperty {
        ...
        val accruals: String = "Traditional accounting"
        val change: String = "Change"
        val link: String = controllers.agent.tasklist.ukproperty.routes.PropertyCheckYourAnswersController.show().url
      }
      ...
      object ForeignProperty {
        ...
        val accruals: String = "Traditional accounting"
        val change: String = "Change"
        val link: String = controllers.agent.tasklist.overseasproperty.routes.OverseasPropertyCheckYourAnswersController.show().url
      }
