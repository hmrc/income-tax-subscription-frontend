...
import messagelookup.agent.MessageLookup.SignUpComplete._
...
import views.html.agent.confirmation.SignUpComplete
...
class SignUpCompleteViewSpec extends ViewSpec {
  ...
  "The Sign Up Complete view" should {
    ...
    "have a sign-up-complete panel" which {
      ...
      "has paragraph 1" in {
        ...
        firstPara.attr("class") mustBe "govuk-panel__body"
      }
      ...
      "has paragraph 2" in {
        ...
        secondPara.attr("class") mustBe "govuk-panel__body"
      }
  ...
  private object SignUpComplete {
    ...
    val whatNowHeadingParagraph2 = "It may take a few hours before new information is displayed in your agent service account (opens in new tab)."
