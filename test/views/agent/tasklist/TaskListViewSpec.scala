      ...
      "display the dynamic content correctly" when {
        "there is no user data" must {
          ...
          "display the add a business link" in {
            ...
            businessLink.attr("href") mustBe controllers.agent.tasklist.addbusiness.routes.WhatIncomeSourceToSignUpController.show().url
          }
    ...
    "given partial task list model" must {
      ...
      "display an incomplete self employment" which {
        ...
        "contains a remove link" in {
          ...
          selfEmploymentRemoveLink.attr("href") mustBe controllers.agent.tasklist.selfemployment.routes.RemoveSelfEmploymentBusinessController.show("id2").url
        }
      }
      ...
      "display an incomplete UK property business" which {
        ...
        "contains a change link" in {
          ...
          ukPropertyIncomeLink.attr("href") mustBe controllers.agent.tasklist.ukproperty.routes.PropertyCheckYourAnswersController.show(editMode = true).url
        ...
        "contains a remove link" in {
          ...
          ukPropertyRemoveLink.attr("href") mustBe controllers.agent.tasklist.ukproperty.routes.RemoveUkPropertyController.show.url
        }
      }
      ...
      "display an incomplete overseas property business" which {
        ...
        "contains a change link" in {
          ...
          overseasPropertyLink.attr("href") mustBe controllers.agent.tasklist.overseasproperty.routes.OverseasPropertyCheckYourAnswersController.show(editMode = true).url
        ...
        "contains a remove link" in {
          ...
          overseasPropertyRemoveLink.attr("href") mustBe controllers.agent.tasklist.overseasproperty.routes.RemoveOverseasPropertyController.show.url
        }
      }
