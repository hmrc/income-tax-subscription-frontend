...
class CannotTakePartViewSpec extends ViewSpec {
  ...
  object MTDExempt2627 {
    val heading = "Your client is exempt from Making Tax Digital for Income Tax"
    val paragraph1 = "Your client is exempt from using Making Tax Digital for Income Tax for the 2026 to 2027 tax year."
  ...
  object DigitallyExempt {
    ...
    val paragraph1LinkHref = "https://www.gov.uk/guidance/apply-for-an-exemption-from-making-tax-digital-for-income-tax#after-you-have-applied"
    val signUpAnotherClientLink = "Sign up another client"
  }
}
