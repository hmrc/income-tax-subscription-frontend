...
class YourIncomeSourceToSignUpViewSpec extends ViewSpec {
  ...
  object IndividualIncomeSource {
    ...
    val foreignPropertyDescription = "A foreign property business is when you get income from land or buildings in another country. For example: letting houses, flat or holiday homes either on a long or short term basis."
