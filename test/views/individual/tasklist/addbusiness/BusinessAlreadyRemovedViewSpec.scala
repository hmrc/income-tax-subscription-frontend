...
class BusinessAlreadyRemovedViewSpec extends ViewSpec {
  ...
  "BusinessAlreadyRemoved" must {
    ...
    "contains a paragraph with link" in {
      ...
      link.attr("href") mustBe controllers.individual.tasklist.addbusiness.routes.YourIncomeSourceToSignUpController.show.url
  ...
  object BusinessAlreadyRemovedMessages {
    ...
    val paraLinkText: String = "your income sources"
