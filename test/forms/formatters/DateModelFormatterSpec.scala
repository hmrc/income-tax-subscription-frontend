      ...
      s"isAgent is set to $isAgent" should {
        ...
        "return an error" when {
          ...
          "the day and month fields are empty" in {
            ...
            result mustBe Left(Seq(FormError(bindingKey, errorKey(isAgent)("error.test.day_month.empty"))))
          }
          "the day and year fields are empty" in {
            ...
            result mustBe Left(Seq(FormError(bindingKey, errorKey(isAgent)("error.test.day_year.empty"))))
          }
          "the month and year fields are empty" in {
            ...
            result mustBe Left(Seq(FormError(bindingKey, errorKey(isAgent)("error.test.month_year.empty"))))
          }
          "all fields are empty" in {
            val result = dateModelFormatter(isAgent).bind(bindingKey, inputMap(day = None, month = None, year = None))
            result mustBe Left(Seq(FormError(bindingKey, errorKey(isAgent)("error.test.date.empty"))))
          }
          ...
          "the month field is invalid" when {
            "the month is text" in {
              ...
              result mustBe Left(Seq(FormError(bindingKey, errorKey(isAgent)("error.test.invalid"))))
            }
            "the month is 0" in {
