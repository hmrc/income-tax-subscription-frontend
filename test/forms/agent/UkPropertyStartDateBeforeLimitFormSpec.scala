...
import forms.agent.UkPropertyStartDateBeforeLimitForm._
...
class UkPropertyStartDateBeforeLimitFormSpec extends PlaySpec {

  val form: Form[YesNo] = ukPropertyStartDateBeforeLimitForm

  "ukPropertyStartDateBeforeLimitForm" should {
