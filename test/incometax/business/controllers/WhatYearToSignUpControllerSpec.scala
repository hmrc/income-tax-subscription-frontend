  ...
  "submit" should {
    ...
    "When it is not in edit mode" should {
      ...
      "redirect to business accounting period page" in {
        ...
        redirectLocation(goodRequest) mustBe Some(business.controllers.routes.BusinessAccountingMethodController.show().url)
      ...
      "the user click back url" should {
        "redirect to Match Tax Year page" in {
          TestWhatYearToSignUpController.backUrl(isEditMode = false) mustBe
            business.controllers.routes.MatchTaxYearController.show().url
        }
      }
    }
