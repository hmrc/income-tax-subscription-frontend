...
class AccountingPeriodTestAccountingPeriodServiceSpec extends AnyWordSpecLike
  with Matchers with OptionValues with BeforeAndAfterEach with MockCurrentDateProvider {
