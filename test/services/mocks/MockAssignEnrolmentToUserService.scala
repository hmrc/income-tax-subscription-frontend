...
import services.AssignEnrolmentToUserService
import services.AssignEnrolmentToUserService.EnrolmentAssignmentResponse
import uk.gov.hmrc.http.HeaderCarrier

import scala.concurrent.Future

trait MockAssignEnrolmentToUserService extends MockitoSugar with BeforeAndAfterEach {
  this: Suite =>
