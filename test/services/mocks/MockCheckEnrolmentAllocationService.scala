...
import services.CheckEnrolmentAllocationService
import services.CheckEnrolmentAllocationService.CheckEnrolmentAllocationResponse
...
trait MockCheckEnrolmentAllocationService extends MockitoSugar with BeforeAndAfterEach {
  ...
  def mockGetGroupIdForEnrolment(utr: String)(response: CheckEnrolmentAllocationResponse): Unit = {
