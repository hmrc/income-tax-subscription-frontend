...
import connectors.GetITSAStatusConnector
...
trait MockGetITSAStatusConnector extends MockitoSugar with BeforeAndAfterEach {
  suite: Suite =>

  val mockGetITSAStatusConnector: GetITSAStatusConnector = mock[GetITSAStatusConnector]
