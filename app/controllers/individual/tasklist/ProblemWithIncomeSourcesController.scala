...
import views.html.individual.tasklist.ProblemWithIncomeSources

import javax.inject.{Inject, Singleton}
import scala.concurrent.ExecutionContext

@Singleton
class ProblemWithIncomeSourcesController @Inject()(view: ProblemWithIncomeSources)
  ...
  def show: Action[AnyContent] = Authenticated { implicit request =>
    _ =>
      Ok(view(
        postAction = controllers.individual.tasklist.addbusiness.routes.YourIncomeSourceToSignUpController.show,
