...
object FeatureSwitch {
  ...
  case object SignUpEligibility extends FeatureSwitch {
    override val name: String = s"$prefix.sign-up-eligibility"
    override val displayText: String = "Sign up eligibility"
  }
}
