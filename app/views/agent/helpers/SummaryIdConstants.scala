...
object SummaryIdConstants {
  ...
  val OverseasPropertyStartDateId = "overseasPropertyStartDate"
  val OverseasAccountingMethodPropertyId = "overseasAccountingMethodProperty"
  val PropertyStartDateId = "propertyStartDate"
