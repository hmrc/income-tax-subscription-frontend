...
import connectors.models.gg.{KnownFactsRequest, KnownFactsResponse, TypeValuePair}
import uk.gov.hmrc.play.http.HeaderCarrier

import scala.concurrent.Future

class KnownFactsService @Inject()(gGAdminConnector: GGAdminConnector) {
  def addKnownFacts(mtditId: String, nino: String)(implicit hc: HeaderCarrier): Future[KnownFactsResponse] = {
