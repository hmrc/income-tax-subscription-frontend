...
object IVHandoffAuditing {

  val handoffAuditType: String = "LowConfidenceLevelIvHandoff"

  case class IVHandoffAuditModel(handoffReason: String,
                                 currentConfidence: Int,
                                 minConfidence: Int) extends AuditModel {
    ...
    override val auditType: String = handoffAuditType
